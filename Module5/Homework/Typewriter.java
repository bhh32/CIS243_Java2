...
public class Typewriter {
    public static void main(String[] args) throws FileNotFoundException {
        System.out.println("Welcome to the Monkey's Typewriter!");
        System.out.println();
    ...
    public static String getSymbol(Scanner console, Monkey solver) {
        System.out.println();
    ...
    // generates that many using the provided Monkey and displays them to the 
    // console.
    public static void doGenerate(Scanner console, Monkey solver, String symbol) {
        ...
        if (console.hasNextInt()) {
            ...
            if (number < 0) {
                ...
                for (int i = 0; i < number; i++) {
                    String result = solver.getRandom(symbol);
