...
/** 
 * The graphical user interface (GUI) that talks to your InfoTree
 * to play a graphical guessing game ("The Sith Sense").
 */
public class HotOrColdSwing implements ActionListener, KeyListener, Runnable, UserInteraction {
    ...
    private static final String HOT_MESSAGE = "Hot";
    private static final String COLD_MESSAGE = "Cold";
    private static final char HOT_LETTER = 'h';
    private static final char COLD_LETTER = 'c';
    ...
    private JButton hotButton, coldButton;
    private JCheckBox musicBox, soundBox;
    private AudioClip musicClip;
    private InfoTree game;
    ...
    public HotOrColdSwing() {
        ...
        hotButton = makeButton(HOT_MESSAGE, new Point(340, 50), new Dimension(80, 30));
        coldButton = makeButton(COLD_MESSAGE, new Point(440, 50), new Dimension(80, 30));
        hotButton.addKeyListener(this);
        coldButton.addKeyListener(this);
    ...
    public void keyPressed(KeyEvent event) {
        if (!hotButton.isVisible() || event.isAltDown() || event.isControlDown()) {
            return;
        }
    ...
    /** Waits for the user to press Hot or Cold and returns the boolean. */
    public boolean nextBoolean() {
        ...
        try {
            ...
            if (CONSOLE_OUTPUT) {
                System.out.println(result ? HOT_MESSAGE : COLD_MESSAGE);
            }
            return result;
    ...
    private void doEnabling() {
        ...
        hotButton.setVisible(waitingForBoolean);
        coldButton.setVisible(waitingForBoolean);
    ...
    // response to a 'cold' button click or typing 'c'
    private void cold() {
        try {
    ...
    private void saveLoad(boolean save) {
        ...
        if (nextBoolean()) {
            ...
            try {
                ...
                if (game == null) game = new InfoTree("computer");
            }
        }
    }
    ...
    // sets the GUI to wait for a hot/cold user input
    ...
    // response to a 'hot' button click or typing 'h'
    private void hot() {
        try {
